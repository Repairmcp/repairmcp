...
OUTPUT: { id, title, text, url, metadata }. text is the section verbatim, subsection numbering preserved, with its citation. CCR rules carry their effective date; CRS statutes carry the edition. These quote official Colorado text and are not legal advice — and Bulletin B-5.04 in particular is Division of Insurance guidance, not law.

CITATION DISCIPLINE: metadata.citation carries the correct short form, e.g. "CRS 10-4-120, 2026 edition" or "3 CCR 702-5-1-14, effective 9/1/2012". Use it verbatim — never reformat it.`;
